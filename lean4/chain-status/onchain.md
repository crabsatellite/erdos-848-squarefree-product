...
* closure constants: 1700  *  closure modules: 42
...
| `Erdos848/Infrastructure/ResidueCertificates.lean` | 11 | squareDivides_five_mul_add_one_of_candidate_eighteen, residueCandidateSharp, residueCandidateSevenSharp (+1 more) |
...
| file | decls | axioms |
|------|------:|-------:|
| `Erdos848/Infrastructure/SquarefreeAP.lean` | 1895 | 4 |
