...
| `Erdos848.globalActiveStrictMiddleCreditMatchingCut` | `Erdos848/Infrastructure/SquarefreeAP.lean` | OPEN (whitelisted) |
| `Erdos848.globalOppositeNearbyMatchingCut` | `Erdos848/Infrastructure/SquarefreeAP.lean` | OPEN (whitelisted) |
