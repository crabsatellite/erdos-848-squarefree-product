...
graph TD
  ...
  Erdos848_{{ "" }}:::cut
  Quot_sound{{ "sound" }}:::cut
  Erdos848_erdos848_main>"erdos848_main"]:::endpoint
  Erdos848_erdos848_main --> Classical_choice
  Erdos848_erdos848_main --> Erdos848_
