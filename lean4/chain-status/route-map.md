...
- Primary proof gap: `gap:G-squarefree-ap-hall-expansion` -- Replace finite Hall checks by one explicit finite-offset middle-compressed analytic cut for the endpoint-consumed `7 mod 25` progression: the opposite block has the seven-offset matching and the strict middle is paid by the induced credit-capacity pool.
...
- Success criterion: A theorem of the shape `SquarefreeAPHallCertificate` is proved without `finiteOffsetMiddleCompressedCapacityCut`.
...
- `Erdos848.finiteOffsetMiddleCompressedCapacityCut` in `Erdos848/Infrastructure/SquarefreeAP.lean`
...
- Prove the remaining finite-offset middle-compression cut: the seven-offset opposite matching plus the induced strict-middle credit-capacity pool must hold for every compatible outside clique.
- Keep the direct partitioned-capacity theorem as a kernel-derived consequence of that middle-compressed cut.
- Final success criterion: A theorem of the shape `SquarefreeAPHallCertificate` is proved without `finiteOffsetMiddleCompressedCapacityCut`.
...
|----------|-------------------|-----------------:|
| `Erdos848.erdos848_main` | `Erdos848.finiteOffsetMiddleCompressedCapacityCut` | 4 |
...
| `gap:G-squarefree-ap-hall-expansion` | open | `chain:hall-expansion-compression`, `chain:main-full-close` | `Erdos848.finiteOffsetMiddleCompressedCapacityCut`, `Erdos848.partitionedSquarefreeAPCapacityCut`, `Erdos848.partitionedSquarefreeAPCapacity_of_finiteOffsetSplitCapacity`, +101 more | cut: 1 |
