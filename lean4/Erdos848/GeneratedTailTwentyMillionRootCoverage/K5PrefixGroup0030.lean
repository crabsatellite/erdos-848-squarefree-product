...
theorem k5PrefixGroup0030_mask_group0001_passes :
...
theorem k5PrefixGroup0030_mask_primes_pass :
    k5PrefixGroup0030MaskPrimes.all
      (Erdos848.twentyMillionRootMaskPassesWith
        k5PrefixGroup0030NormalLookup
        k5PrefixGroup0030TwistLookup) = true := by
  simp only [k5PrefixGroup0030MaskPrimes, List.all_append]
  rw [k5PrefixGroup0030_mask_group0000_passes]
  rw [k5PrefixGroup0030_mask_group0001_passes]
  rfl
