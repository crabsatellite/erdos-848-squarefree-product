import Erdos848.GeneratedTailTwentyMillionRootCoverage.K0PrefixGroup0000
...
theorem k0CertifiedPrefixes_eq :
    k0CertifiedPrefixes =
      Erdos848.twentyMillionRootFeasiblePrefixes 0 := by
  rfl

theorem k0_certified_of_mem
    {support : List ℕ}
    (hsupport : support ∈
      Erdos848.twentyMillionRootFeasiblePrefixes 0) :
