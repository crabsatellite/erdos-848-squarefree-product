...
def orderCellOne60004Tree : IndexedMarkerData.AdjacentIndexTree :=
...
theorem orderCellOne60004Check :
    orderCellOne60004Tree.check cellMarkerOne6 6912 = true := by decide

theorem orderCellOne60004 :
    IndexedMarkerData.AdjacentIndexTree.RangeOrdered cellMarkerOne6 6912 6977 := by
  simpa [orderCellOne60004Tree, IndexedMarkerData.AdjacentIndexTree.size] using
    IndexedMarkerData.AdjacentIndexTree.range orderCellOne60004Check
