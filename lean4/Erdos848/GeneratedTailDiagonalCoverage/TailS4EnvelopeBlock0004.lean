...
theorem tailEnvelope0064Four :
    TailDiagonalCellRatioRange 4 6880110 6914510
...
theorem tailEnvelope0065Four :
    TailDiagonalCellRatioRange 4 6914510 6949082
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0066Four :
    TailDiagonalCellRatioRange 4 6949082 6983827
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0067Four :
    TailDiagonalCellRatioRange 4 6983827 7018746
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0068Four :
    TailDiagonalCellRatioRange 4 7018746 7053839
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0069Four :
    TailDiagonalCellRatioRange 4 7053839 7089108
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0070Four :
    TailDiagonalCellRatioRange 4 7089108 7124553
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0071Four :
    TailDiagonalCellRatioRange 4 7124553 7160175
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0072Four :
    TailDiagonalCellRatioRange 4 7160175 7195975
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0073Four :
    TailDiagonalCellRatioRange 4 7195975 7231954
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0074Four :
    TailDiagonalCellRatioRange 4 7231954 7268113
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0075Four :
    TailDiagonalCellRatioRange 4 7268113 7304453
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0076Four :
    TailDiagonalCellRatioRange 4 7304453 7340975
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0077Four :
    TailDiagonalCellRatioRange 4 7340975 7377679
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0078Four :
    TailDiagonalCellRatioRange 4 7377679 7414567
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0079Four :
    TailDiagonalCellRatioRange 4 7414567 7451639
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
