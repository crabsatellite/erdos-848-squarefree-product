...
def orderCellOne70004Tree : IndexedMarkerData.AdjacentIndexTree :=
...
theorem orderCellOne70004Check :
    orderCellOne70004Tree.check cellMarkerOne7 6912 = true := by decide

theorem orderCellOne70004 :
    IndexedMarkerData.AdjacentIndexTree.RangeOrdered cellMarkerOne7 6912 6977 := by
  simpa [orderCellOne70004Tree, IndexedMarkerData.AdjacentIndexTree.size] using
    IndexedMarkerData.AdjacentIndexTree.range orderCellOne70004Check
