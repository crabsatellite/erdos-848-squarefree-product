...
theorem tailEnvelope0080Four :
    TailDiagonalCellRatioRange 4 7451639 7488897
...
theorem tailEnvelope0081Four :
    TailDiagonalCellRatioRange 4 7488897 7526341
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0082Four :
    TailDiagonalCellRatioRange 4 7526341 7563972
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0083Four :
    TailDiagonalCellRatioRange 4 7563972 7601791
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0084Four :
    TailDiagonalCellRatioRange 4 7601791 7639799
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0085Four :
    TailDiagonalCellRatioRange 4 7639799 7677997
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0086Four :
    TailDiagonalCellRatioRange 4 7677997 7716386
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0087Four :
    TailDiagonalCellRatioRange 4 7716386 7754967
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0088Four :
    TailDiagonalCellRatioRange 4 7754967 7793741
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0089Four :
    TailDiagonalCellRatioRange 4 7793741 7832709
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0090Four :
    TailDiagonalCellRatioRange 4 7832709 7871872
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0091Four :
    TailDiagonalCellRatioRange 4 7871872 7911231
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0092Four :
    TailDiagonalCellRatioRange 4 7911231 7950787
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0093Four :
    TailDiagonalCellRatioRange 4 7950787 7990540
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0094Four :
    TailDiagonalCellRatioRange 4 7990540 8030492
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
...
theorem tailEnvelope0095Four :
    TailDiagonalCellRatioRange 4 8030492 8070644
      (2820875304780435 / 1000000000000000000) := by
  intro N hLower hStop parity cells hcard
