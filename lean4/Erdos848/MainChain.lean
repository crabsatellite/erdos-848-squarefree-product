  ...
  researchChains := [
    ...
    },
    {
      ...
      attackPlan := [
        ...
        "Prove the remaining source-index split certificate: `GlobalOppositeFiniteOffsetEighteenTypedSourceIndexValidMatching` plus the total reserve-dominance inequality for the induced source-index mate on every compatible outside clique.",
