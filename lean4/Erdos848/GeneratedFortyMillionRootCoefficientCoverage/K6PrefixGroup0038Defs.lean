...
def k6PrefixGroup0038RootCoefficientPasses (row : List Nat × Nat) : Bool :=
  Erdos848.fortyMillionRootCorePrefixPasses coefficientCeiling
    Erdos848.GeneratedTailGlobalMixedSupportCoverage.k6PrefixGroup0038NormalLookup
    Erdos848.GeneratedTailGlobalMixedSupportCoverage.k6PrefixGroup0038TwistLookup 6
