...
def k7PrefixGroup0006RootCoefficientPasses (row : List Nat × Nat) : Bool :=
  Erdos848.fortyMillionRootCorePrefixPasses coefficientCeiling
    Erdos848.GeneratedTailGlobalMixedSupportCoverage.k7PrefixGroup0006NormalLookup
    Erdos848.GeneratedTailGlobalMixedSupportCoverage.k7PrefixGroup0006TwistLookup 7
