...
theorem fiveMillionFiveCellBasePeriodicThreshold_ratio_le_at_lower
    ...
    ((((hallBasePart N B).filter fun point =>
      ...
      2 * (167 / 588 : Rat) / 25 +
        2 * ((167 / 588 : Rat) + 70307 / 196) / lower := by
...
#print axioms fiveMillionFiveCellBasePeriodicThreshold_ratio_le_at_lower
