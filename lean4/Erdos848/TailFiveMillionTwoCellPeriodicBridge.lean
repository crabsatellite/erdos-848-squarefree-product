...
theorem fiveMillionTwoCellBasePeriodicThreshold_ratio_le_at_lower
    ...
    ((((hallBasePart N B).filter fun point =>
      ...
      2 * (40 / 147 : Rat) / 25 +
        2 * ((40 / 147 : Rat) + 17120 / 49) / lower := by
...
#print axioms fiveMillionTwoCellBasePeriodicThreshold_ratio_le_at_lower
