...
the simple typed mate, stated with generated prefix-pair source witnesses that
imply target-prefix source witnesses and the prefix reserve witness, and with
