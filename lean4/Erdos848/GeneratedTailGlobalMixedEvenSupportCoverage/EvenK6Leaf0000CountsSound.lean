...
theorem evenK6TerminalGroup0000_counts :
    [
      evenK6TerminalGroup0000FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0000Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0000Row0000,
...
#print axioms evenK6TerminalGroup0000_counts
