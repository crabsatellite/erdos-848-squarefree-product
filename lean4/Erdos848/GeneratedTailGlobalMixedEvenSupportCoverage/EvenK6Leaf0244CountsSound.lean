...
theorem evenK6TerminalGroup0244_counts :
    [
      evenK6TerminalGroup0244FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0244Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0244FinalRows0000,
      evenK6TerminalGroup0244Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0134,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0312,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0571,
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0662,      ]
  simp

#print axioms evenK6TerminalGroup0244_counts
