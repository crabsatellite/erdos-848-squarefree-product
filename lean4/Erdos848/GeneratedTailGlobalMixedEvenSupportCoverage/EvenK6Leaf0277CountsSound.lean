...
theorem evenK6TerminalGroup0277_counts :
    [
      evenK6TerminalGroup0277FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0277Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0277FinalRows0000,
      evenK6TerminalGroup0277Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0159,
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0166,
...
#print axioms evenK6TerminalGroup0277_counts
