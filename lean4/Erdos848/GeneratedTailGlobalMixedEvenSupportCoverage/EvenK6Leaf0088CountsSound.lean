...
theorem evenK6TerminalGroup0088_counts :
    [
      evenK6TerminalGroup0088FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0088Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0088Row0000,
...
#print axioms evenK6TerminalGroup0088_counts
