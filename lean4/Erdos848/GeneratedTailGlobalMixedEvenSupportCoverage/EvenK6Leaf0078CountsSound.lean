...
theorem evenK6TerminalGroup0078_counts :
    [
      evenK6TerminalGroup0078FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0078Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0078Row0000,
...
#print axioms evenK6TerminalGroup0078_counts
