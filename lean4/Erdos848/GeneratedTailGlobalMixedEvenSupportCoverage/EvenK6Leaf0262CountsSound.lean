...
theorem evenK6TerminalGroup0262_counts :
    [
      evenK6TerminalGroup0262FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0262Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0262FinalRows0000,
      evenK6TerminalGroup0262Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0150,
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0158,
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0202,
...
#print axioms evenK6TerminalGroup0262_counts
