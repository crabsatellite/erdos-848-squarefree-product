...
theorem evenK6TerminalGroup0035_counts :
    [
      evenK6TerminalGroup0035FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0035Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0035Row0000,
...
#print axioms evenK6TerminalGroup0035_counts
