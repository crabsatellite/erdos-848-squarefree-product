...
theorem evenK6TerminalGroup0268_counts :
    [
      evenK6TerminalGroup0268FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0268Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0268FinalRows0000,
      evenK6TerminalGroup0268Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0116,
...
#print axioms evenK6TerminalGroup0268_counts
