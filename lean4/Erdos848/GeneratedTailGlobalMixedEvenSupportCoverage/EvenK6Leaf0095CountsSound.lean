...
theorem evenK6TerminalGroup0095_counts :
    [
      evenK6TerminalGroup0095FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0095Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0095FinalRows0000,
      evenK6TerminalGroup0095Row0000,
...
#print axioms evenK6TerminalGroup0095_counts
