...
theorem evenK6TerminalGroup0257_counts :
    [
      evenK6TerminalGroup0257FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0257Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0257Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0120,
...
#print axioms evenK6TerminalGroup0257_counts
