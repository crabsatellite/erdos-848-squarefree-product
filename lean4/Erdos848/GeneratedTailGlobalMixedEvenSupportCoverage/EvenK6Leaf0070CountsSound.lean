...
theorem evenK6TerminalGroup0070_counts :
    [
      evenK6TerminalGroup0070FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0070Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0070Row0000,
...
#print axioms evenK6TerminalGroup0070_counts
