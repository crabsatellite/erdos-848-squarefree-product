...
theorem evenK6TerminalGroup0041_counts :
    [
      evenK6TerminalGroup0041FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0041Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0041Row0000,
...
#print axioms evenK6TerminalGroup0041_counts
