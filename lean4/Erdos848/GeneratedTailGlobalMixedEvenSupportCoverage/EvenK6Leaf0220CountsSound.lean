...
theorem evenK6TerminalGroup0220_counts :
    [
      evenK6TerminalGroup0220FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0220Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0220Row0000,
...
#print axioms evenK6TerminalGroup0220_counts
