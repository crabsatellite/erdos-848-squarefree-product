...
theorem evenK6TerminalGroup0251_counts :
    [
      evenK6TerminalGroup0251FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0251Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0251FinalRows0000,
      evenK6TerminalGroup0251Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0112,
...
#print axioms evenK6TerminalGroup0251_counts
