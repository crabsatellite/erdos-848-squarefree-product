...
theorem evenK6TerminalGroup0159_counts :
    [
      evenK6TerminalGroup0159FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0159Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0159Row0000,
...
#print axioms evenK6TerminalGroup0159_counts
