...
theorem evenK6TerminalGroup0092_counts :
    [
      evenK6TerminalGroup0092FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0092Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0092FinalRows0000,
      evenK6TerminalGroup0092Row0000,
...
#print axioms evenK6TerminalGroup0092_counts
