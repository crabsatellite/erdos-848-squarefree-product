...
theorem evenK6TerminalGroup0206_counts :
    [
      evenK6TerminalGroup0206FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0206Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0206Row0000,
...
#print axioms evenK6TerminalGroup0206_counts
