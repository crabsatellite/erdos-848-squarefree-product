...
theorem evenK6TerminalGroup0190_counts :
    [
      evenK6TerminalGroup0190FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0190Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0190Row0000,
...
#print axioms evenK6TerminalGroup0190_counts
