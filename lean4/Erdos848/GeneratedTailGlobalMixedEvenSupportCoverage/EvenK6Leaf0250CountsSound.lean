...
theorem evenK6TerminalGroup0250_counts :
    [
      evenK6TerminalGroup0250FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0250Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0250FinalRows0000,
      evenK6TerminalGroup0250Row0000,
...
#print axioms evenK6TerminalGroup0250_counts
