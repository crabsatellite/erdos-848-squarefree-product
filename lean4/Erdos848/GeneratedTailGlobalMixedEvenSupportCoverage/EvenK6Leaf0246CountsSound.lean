...
theorem evenK6TerminalGroup0246_counts :
    [
      evenK6TerminalGroup0246FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0246Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0246Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0533,
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0663,      ]
  simp

#print axioms evenK6TerminalGroup0246_counts
