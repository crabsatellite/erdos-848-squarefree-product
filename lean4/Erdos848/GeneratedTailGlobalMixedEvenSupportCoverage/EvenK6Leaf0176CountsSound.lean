...
theorem evenK6TerminalGroup0176_counts :
    [
      evenK6TerminalGroup0176FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0176Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0176Row0000,
...
#print axioms evenK6TerminalGroup0176_counts
