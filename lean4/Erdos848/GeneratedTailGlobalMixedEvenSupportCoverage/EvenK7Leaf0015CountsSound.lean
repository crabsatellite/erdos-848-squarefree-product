import Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.EvenK7Leaf0015Data
...
theorem evenK7TerminalGroup0015_counts :
    [
      evenK7TerminalGroup0015FinalRows0000.counts
    ] =
    [
      evenK7TerminalGroup0015Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK7TerminalGroup0015FinalRows0000,
      evenK7TerminalGroup0015Row0000,
...
#print axioms evenK7TerminalGroup0015_counts
