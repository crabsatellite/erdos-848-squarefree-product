...
theorem evenK6TerminalGroup0286_counts :
    [
      evenK6TerminalGroup0286FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0286Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0286Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0022,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0102,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0236,
...
#print axioms evenK6TerminalGroup0286_counts
