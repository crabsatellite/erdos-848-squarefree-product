...
theorem evenK6TerminalGroup0240_counts :
    [
      evenK6TerminalGroup0240FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0240Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0240Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0546,
...
#print axioms evenK6TerminalGroup0240_counts
