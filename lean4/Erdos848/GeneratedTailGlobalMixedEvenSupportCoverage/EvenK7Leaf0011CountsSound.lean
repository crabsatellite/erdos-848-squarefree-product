...
theorem evenK7TerminalGroup0011_counts :
    [
      evenK7TerminalGroup0011FinalRows0000.counts
    ] =
    [
      evenK7TerminalGroup0011Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK7TerminalGroup0011FinalRows0000,
      evenK7TerminalGroup0011Row0000,
...
#print axioms evenK7TerminalGroup0011_counts
