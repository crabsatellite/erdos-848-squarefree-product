...
theorem evenK6TerminalGroup0119_counts :
    [
      evenK6TerminalGroup0119FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0119Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0119Row0000,
...
#print axioms evenK6TerminalGroup0119_counts
