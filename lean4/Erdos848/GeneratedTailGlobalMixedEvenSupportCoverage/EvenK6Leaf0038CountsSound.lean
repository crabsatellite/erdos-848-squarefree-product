...
theorem evenK6TerminalGroup0038_counts :
    [
      evenK6TerminalGroup0038FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0038Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0038Row0000,
...
#print axioms evenK6TerminalGroup0038_counts
