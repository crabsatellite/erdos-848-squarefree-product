...
theorem evenK6TerminalGroup0061_counts :
    [
      evenK6TerminalGroup0061FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0061Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0061Row0000,
...
#print axioms evenK6TerminalGroup0061_counts
