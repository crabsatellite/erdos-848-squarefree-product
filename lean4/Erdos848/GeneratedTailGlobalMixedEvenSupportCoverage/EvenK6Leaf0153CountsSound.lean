...
theorem evenK6TerminalGroup0153_counts :
    [
      evenK6TerminalGroup0153FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0153Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0153Row0000,
...
#print axioms evenK6TerminalGroup0153_counts
