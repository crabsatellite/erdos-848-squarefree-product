...
theorem evenK6TerminalGroup0273_counts :
    [
      evenK6TerminalGroup0273FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0273Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0273FinalRows0000,
      evenK6TerminalGroup0273Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0169,
...
#print axioms evenK6TerminalGroup0273_counts
