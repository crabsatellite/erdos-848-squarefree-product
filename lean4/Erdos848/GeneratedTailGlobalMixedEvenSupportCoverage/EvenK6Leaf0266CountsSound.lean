...
theorem evenK6TerminalGroup0266_counts :
    [
      evenK6TerminalGroup0266FinalRows0000.counts
    ] =
    [
      evenK6TerminalGroup0266Row0000.counts.toBitVec
    ] := by
  simp (config := { maxSteps := 1000000 }) only
    [
      ...
      evenK6TerminalGroup0266FinalRows0000,
      evenK6TerminalGroup0266Row0000,
      ...
      Erdos848.GeneratedTailGlobalMixedEvenSupportCoverage.certifiedWordCount0572,      ]
  simp

#print axioms evenK6TerminalGroup0266_counts
