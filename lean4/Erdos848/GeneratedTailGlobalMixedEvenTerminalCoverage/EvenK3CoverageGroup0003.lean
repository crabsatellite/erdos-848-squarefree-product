...
def evenK3CoverageGroup0003Prefixes : List (List Nat) :=
  Erdos848.GeneratedTailGlobalMixedSupportCoverage.k3PrefixGroup0003.map Prod.fst

theorem evenK3CoverageGroup0003_passes :
    evenK3CoverageGroup0003Prefixes.all
      (Erdos848.globalMixedEvenChoicePasses
        3 evenK3Selector EvenK3Choice.terminal) = true := by
  rfl

#print axioms evenK3CoverageGroup0003_passes
