...
def evenK3CoverageGroup0022Prefixes : List (List Nat) :=
  Erdos848.GeneratedTailGlobalMixedSupportCoverage.k3PrefixGroup0022.map Prod.fst

theorem evenK3CoverageGroup0022_passes :
    evenK3CoverageGroup0022Prefixes.all
      (Erdos848.globalMixedEvenChoicePasses
        3 evenK3Selector EvenK3Choice.terminal) = true := by
  rfl

#print axioms evenK3CoverageGroup0022_passes
