...
theorem supportPrimeGroup0029_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0029) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup)))))))))))))))))))))))))))))

theorem supportPrimeSemanticGroup0029
    {p : ℕ}
    (hLower : 15938 ≤ p) (hUpper : p ≤ 16619)
  ...
  apply supportPrimeGroup0029_subset
  interval_cases p <;>
