...
theorem supportPrimeGroup0022_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0022) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup))))))))))))))))))))))

theorem supportPrimeSemanticGroup0022
    {p : ℕ}
  ...
  apply supportPrimeGroup0022_subset
  interval_cases p <;>
