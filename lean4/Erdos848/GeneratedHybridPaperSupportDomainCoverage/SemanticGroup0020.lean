...
theorem supportPrimeGroup0020_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0020) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup))))))))))))))))))))

theorem supportPrimeSemanticGroup0020
    {p : ℕ}
  ...
  apply supportPrimeGroup0020_subset
  interval_cases p <;>
