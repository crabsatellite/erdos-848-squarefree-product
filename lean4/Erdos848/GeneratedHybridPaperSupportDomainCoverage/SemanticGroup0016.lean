...
theorem supportPrimeGroup0016_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0016) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup))))))))))))))))

theorem supportPrimeSemanticGroup0016
    {p : ℕ}
  ...
  apply supportPrimeGroup0016_subset
  interval_cases p <;>
