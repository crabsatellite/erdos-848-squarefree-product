...
theorem supportPrimeGroup0019_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0019) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup)))))))))))))))))))

theorem supportPrimeSemanticGroup0019
    {p : ℕ}
  ...
  apply supportPrimeGroup0019_subset
  interval_cases p <;>
