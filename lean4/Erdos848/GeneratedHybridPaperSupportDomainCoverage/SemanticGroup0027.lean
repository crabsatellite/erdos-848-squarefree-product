...
theorem supportPrimeGroup0027_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0027) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup)))))))))))))))))))))))))))

theorem supportPrimeSemanticGroup0027
    {p : ℕ}
    (hLower : 14768 ≤ p) (hUpper : p ≤ 15359)
  ...
  apply supportPrimeGroup0027_subset
  interval_cases p <;>
