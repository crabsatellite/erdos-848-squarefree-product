...
theorem supportPrimeGroup0025_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0025) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup)))))))))))))))))))))))))

theorem supportPrimeSemanticGroup0025
    {p : ℕ}
    (hLower : 13524 ≤ p) (hUpper : p ≤ 14153)
  ...
  apply supportPrimeGroup0025_subset
  interval_cases p <;>
