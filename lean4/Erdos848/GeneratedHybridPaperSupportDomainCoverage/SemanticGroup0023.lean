...
theorem supportPrimeGroup0023_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0023) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup)))))))))))))))))))))))

theorem supportPrimeSemanticGroup0023
    {p : ℕ}
  ...
  apply supportPrimeGroup0023_subset
  interval_cases p <;>
