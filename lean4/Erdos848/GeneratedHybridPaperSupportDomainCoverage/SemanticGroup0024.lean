...
theorem supportPrimeGroup0024_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0024) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup))))))))))))))))))))))))

theorem supportPrimeSemanticGroup0024
    {p : ℕ}
  ...
  apply supportPrimeGroup0024_subset
  interval_cases p <;>
