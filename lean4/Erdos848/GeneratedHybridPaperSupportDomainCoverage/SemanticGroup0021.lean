...
theorem supportPrimeGroup0021_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0021) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup)))))))))))))))))))))

theorem supportPrimeSemanticGroup0021
    {p : ℕ}
    (hLower : 11114 ≤ p) (hUpper : p ≤ 11777)
  ...
  apply supportPrimeGroup0021_subset
  interval_cases p <;>
