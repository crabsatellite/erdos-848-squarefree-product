...
theorem supportPrimeGroup0018_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0018) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup))))))))))))))))))

theorem supportPrimeSemanticGroup0018
    {p : ℕ}
  ...
  apply supportPrimeGroup0018_subset
  interval_cases p <;>
