...
theorem supportPrimeGroup0026_subset
    {p : ℕ} (hpGroup : p ∈ supportPrimeGroup0026) :
    p ∈ supportPrimes := by
  simp only [supportPrimes, List.mem_append]
  exact Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inr (Or.inl hpGroup))))))))))))))))))))))))))

theorem supportPrimeSemanticGroup0026
    {p : ℕ}
    (hLower : 14154 ≤ p) (hUpper : p ≤ 14767)
  ...
  apply supportPrimeGroup0026_subset
  interval_cases p <;>
