...
def k6PrefixGroup0020 : List (List ℕ × ℕ) :=
  [([3, 13, 19, 29, 101], 103),
    ([3, 13, 19, 29, 103], 107),
    ([3, 13, 19, 29, 107], 109),
    ([3, 13, 19, 29, 109], 113),
...
def k6PrefixGroup0020NormalLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0020TwistLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0020Passes (row : List ℕ × ℕ) : Bool :=
  Erdos848.globalMixedCorePrefixPasses
    k6PrefixGroup0020NormalLookup
    k6PrefixGroup0020TwistLookup 6
    (max 5_000_000 (row.1.prod * row.2)) row.1

theorem k6PrefixGroup0020_passes :
    k6PrefixGroup0020.all
      k6PrefixGroup0020Passes = true := by
  rfl
