...
def k6PrefixGroup0014 : List (List ℕ × ℕ) :=
  [([3, 11, 17, 19, 293], 307),
    ([3, 11, 17, 19, 307], 311),
    ([3, 11, 17, 19, 311], 313),
    ([3, 11, 17, 19, 313], 317),
...
def k6PrefixGroup0014NormalLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0014TwistLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0014Passes (row : List ℕ × ℕ) : Bool :=
  Erdos848.globalMixedCorePrefixPasses
    k6PrefixGroup0014NormalLookup
    k6PrefixGroup0014TwistLookup 6
    (max 5_000_000 (row.1.prod * row.2)) row.1

theorem k6PrefixGroup0014_passes :
    k6PrefixGroup0014.all
      k6PrefixGroup0014Passes = true := by
  rfl
