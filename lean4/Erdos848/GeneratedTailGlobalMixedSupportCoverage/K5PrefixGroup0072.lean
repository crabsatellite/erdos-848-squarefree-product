...
def k5PrefixGroup0072 : List (List ℕ × ℕ) :=
  [([13, 29, 53, 139], 149),
    ([13, 29, 53, 149], 151),
    ([13, 29, 53, 151], 157),
    ([13, 29, 53, 157], 163),
...
def k5PrefixGroup0072NormalLookup (p : ℕ) : List ℕ :=
...
def k5PrefixGroup0072TwistLookup (p : ℕ) : List ℕ :=
...
def k5PrefixGroup0072Passes (row : List ℕ × ℕ) : Bool :=
  Erdos848.globalMixedCorePrefixPasses
    k5PrefixGroup0072NormalLookup
    k5PrefixGroup0072TwistLookup 5
    (max 5_000_000 (row.1.prod * row.2)) row.1

theorem k5PrefixGroup0072_passes :
    k5PrefixGroup0072.all
      k5PrefixGroup0072Passes = true := by
  rfl
