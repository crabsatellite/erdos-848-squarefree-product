...
def k6PrefixGroup0008 : List (List ℕ × ℕ) :=
  [([3, 7, 23, 31, 197], 199),
    ([3, 7, 23, 31, 199], 211),
    ([3, 7, 23, 31, 211], 223),
    ([3, 7, 23, 31, 223], 227),
...
def k6PrefixGroup0008NormalLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0008TwistLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0008Passes (row : List ℕ × ℕ) : Bool :=
  Erdos848.globalMixedCorePrefixPasses
    k6PrefixGroup0008NormalLookup
    k6PrefixGroup0008TwistLookup 6
    (max 5_000_000 (row.1.prod * row.2)) row.1

theorem k6PrefixGroup0008_passes :
    k6PrefixGroup0008.all
      k6PrefixGroup0008Passes = true := by
  rfl
