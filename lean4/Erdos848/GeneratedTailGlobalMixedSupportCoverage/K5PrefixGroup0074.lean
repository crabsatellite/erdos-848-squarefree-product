...
def k5PrefixGroup0074 : List (List ℕ × ℕ) :=
  [([13, 47, 89, 101], 103),
    ([13, 47, 89, 103], 107),
    ([13, 47, 89, 107], 109),
    ([13, 47, 89, 109], 113),
...
def k5PrefixGroup0074NormalLookup (p : ℕ) : List ℕ :=
...
def k5PrefixGroup0074TwistLookup (p : ℕ) : List ℕ :=
...
def k5PrefixGroup0074Passes (row : List ℕ × ℕ) : Bool :=
  Erdos848.globalMixedCorePrefixPasses
    k5PrefixGroup0074NormalLookup
    k5PrefixGroup0074TwistLookup 5
    (max 5_000_000 (row.1.prod * row.2)) row.1

theorem k5PrefixGroup0074_passes :
    k5PrefixGroup0074.all
      k5PrefixGroup0074Passes = true := by
  rfl
