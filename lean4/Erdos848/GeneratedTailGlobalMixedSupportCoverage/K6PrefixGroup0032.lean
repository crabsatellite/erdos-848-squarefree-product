...
def k6PrefixGroup0032 : List (List ℕ × ℕ) :=
  [([7, 13, 17, 61, 79], 83),
    ([7, 13, 17, 61, 83], 89),
    ([7, 13, 17, 61, 89], 97),
    ([7, 13, 17, 61, 97], 101),
...
def k6PrefixGroup0032NormalLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0032TwistLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0032Passes (row : List ℕ × ℕ) : Bool :=
  Erdos848.globalMixedCorePrefixPasses
    k6PrefixGroup0032NormalLookup
    k6PrefixGroup0032TwistLookup 6
    (max 5_000_000 (row.1.prod * row.2)) row.1

theorem k6PrefixGroup0032_passes :
    k6PrefixGroup0032.all
      k6PrefixGroup0032Passes = true := by
  rfl
