...
def k5PrefixGroup0075 : List (List ℕ × ℕ) :=
  [([17, 19, 61, 89], 97),
    ([17, 19, 61, 97], 101),
    ([17, 19, 61, 101], 103),
    ([17, 19, 61, 103], 107),
...
def k5PrefixGroup0075NormalLookup (p : ℕ) : List ℕ :=
...
def k5PrefixGroup0075TwistLookup (p : ℕ) : List ℕ :=
...
def k5PrefixGroup0075Passes (row : List ℕ × ℕ) : Bool :=
  Erdos848.globalMixedCorePrefixPasses
    k5PrefixGroup0075NormalLookup
    k5PrefixGroup0075TwistLookup 5
    (max 5_000_000 (row.1.prod * row.2)) row.1

theorem k5PrefixGroup0075_passes :
    k5PrefixGroup0075.all
      k5PrefixGroup0075Passes = true := by
  rfl
