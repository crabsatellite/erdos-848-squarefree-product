...
def k6PrefixGroup0016 : List (List ℕ × ℕ) :=
  [([3, 11, 19, 101, 109], 113),
    ([3, 11, 19, 101, 113], 127),
    ([3, 11, 19, 101, 127], 131),
    ([3, 11, 19, 101, 131], 137),
...
def k6PrefixGroup0016NormalLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0016TwistLookup (p : ℕ) : List ℕ :=
...
def k6PrefixGroup0016Passes (row : List ℕ × ℕ) : Bool :=
  Erdos848.globalMixedCorePrefixPasses
    k6PrefixGroup0016NormalLookup
    k6PrefixGroup0016TwistLookup 6
    (max 5_000_000 (row.1.prod * row.2)) row.1

theorem k6PrefixGroup0016_passes :
    k6PrefixGroup0016.all
      k6PrefixGroup0016Passes = true := by
  rfl
