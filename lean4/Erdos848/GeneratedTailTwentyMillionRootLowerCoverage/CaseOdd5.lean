...
theorem lower_odd_5_le_passes :
    decide (Erdos848.twentyMillionRootSmoothProfileLowerAt
      .odd 5 263157 23078 ≤
        (.odd : Erdos848.TwentyMillionRootRow).envelope) = true := by
  with_unfolding_all decide

theorem lower_odd_5_le :
    Erdos848.twentyMillionRootSmoothProfile .odd 5
  ...
  exact of_decide_eq_true lower_odd_5_le_passes

#print axioms lower_odd_5_le
