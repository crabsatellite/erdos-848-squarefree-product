...
theorem lower_evenThree_1_le_passes :
    decide (Erdos848.twentyMillionRootSmoothProfileLowerAt
      .evenThree 1 285714 24900 ≤
        (.evenThree : Erdos848.TwentyMillionRootRow).envelope) = true := by
  with_unfolding_all decide

theorem lower_evenThree_1_le :
    Erdos848.twentyMillionRootSmoothProfile .evenThree 1
  ...
  exact of_decide_eq_true lower_evenThree_1_le_passes

#print axioms lower_evenThree_1_le
