...
theorem lower_evenOne_7_le_passes :
    decide (Erdos848.twentyMillionRootSmoothProfileLowerAt
      .evenOne 7 263157 23078 ≤
        (.evenOne : Erdos848.TwentyMillionRootRow).envelope) = true := by
  with_unfolding_all decide

theorem lower_evenOne_7_le :
    Erdos848.twentyMillionRootSmoothProfile .evenOne 7
  ...
  exact of_decide_eq_true lower_evenOne_7_le_passes

#print axioms lower_evenOne_7_le
