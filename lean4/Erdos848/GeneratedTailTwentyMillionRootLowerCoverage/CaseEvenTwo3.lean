...
theorem lower_evenTwo_3_le_passes :
    decide (Erdos848.twentyMillionRootSmoothProfileLowerAt
      .evenTwo 3 263157 23078 ≤
        (.evenTwo : Erdos848.TwentyMillionRootRow).envelope) = true := by
  with_unfolding_all decide

theorem lower_evenTwo_3_le :
    Erdos848.twentyMillionRootSmoothProfile .evenTwo 3
  ...
  exact of_decide_eq_true lower_evenTwo_3_le_passes

#print axioms lower_evenTwo_3_le
