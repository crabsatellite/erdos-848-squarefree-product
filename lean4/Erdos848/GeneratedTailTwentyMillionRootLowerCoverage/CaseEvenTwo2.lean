...
theorem lower_evenTwo_2_le_passes :
    decide (Erdos848.twentyMillionRootSmoothProfileLowerAt
      .evenTwo 2 263157 23078 ≤
        (.evenTwo : Erdos848.TwentyMillionRootRow).envelope) = true := by
  with_unfolding_all decide

theorem lower_evenTwo_2_le :
    Erdos848.twentyMillionRootSmoothProfile .evenTwo 2
  ...
  exact of_decide_eq_true lower_evenTwo_2_le_passes

#print axioms lower_evenTwo_2_le
