...
theorem lower_evenOne_6_le_passes :
    decide (Erdos848.twentyMillionRootSmoothProfileLowerAt
      .evenOne 6 263157 23078 ≤
        (.evenOne : Erdos848.TwentyMillionRootRow).envelope) = true := by
  with_unfolding_all decide

theorem lower_evenOne_6_le :
    Erdos848.twentyMillionRootSmoothProfile .evenOne 6
  ...
  exact of_decide_eq_true lower_evenOne_6_le_passes

#print axioms lower_evenOne_6_le
