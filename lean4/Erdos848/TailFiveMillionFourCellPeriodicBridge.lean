...
/-! Periodic bridge for the four-active-cell row (`507 / 1764`). -/

set_option maxHeartbeats 0
set_option maxRecDepth 1000000

theorem fiveMillionFourCellPeriodicNatResidues_card_le_507
...
theorem baseProgressionSubset_card_le_periodic507
    ...
    (hcard : residues.card <= 507) :
    (S.card : Rat) <=
      (169 / 588 : Rat) * ((N : Rat) / 25 + 1) + 70811 / 196 := by
  ...
  have htarget := periodicResidueSet_count_le_507
  ...
  calc
    ...
    _ <= (169 / 588 : Rat) * (((N / 25 : Nat) : Rat) + 1) +
        70811 / 196 := by
      simpa [target] using htarget
    _ <= (169 / 588 : Rat) * ((N : Rat) / 25 + 1) + 70811 / 196 := by
      gcongr

structure FiveMillionFourCellBasePeriodicThresholdCertificate
  ...
  sevenDouble :
    ((Finset.univ.filter fun r9 : FiveMillionModNine =>
      2 <= (sevenModNineEvent r9).card)).card <= 2
  ...
  eighteenDouble :
    ((Finset.univ.filter fun r9 : FiveMillionModNine =>
      2 <= (eighteenModNineEvent r9).card)).card <= 2
...
theorem fiveMillionFourCellBasePeriodicThreshold_ratio_le_at_lower
  ...
  have hsevenBound : (seven.card : Rat) <=
      (169 / 588 : Rat) * ((N : Rat) / 25 + 1) + 70811 / 196 := by
    apply baseProgressionSubset_card_le_periodic507
    ...
    · exact fiveMillionFourCellPeriodicNatResidues_card_le_507 _ _ _
