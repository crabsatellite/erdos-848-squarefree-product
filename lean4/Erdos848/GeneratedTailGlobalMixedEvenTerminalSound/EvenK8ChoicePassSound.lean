import Erdos848.GeneratedTailGlobalMixedEvenTerminalSound.EvenK8ChoiceActualSound
...
theorem evenK8Choice_terminal_endpoint_lower
    (choice : EvenK8Choice) :
    5_000_000 <= choice.terminal.endpoint := by
  cases choice <;> decide

theorem evenK8Choice_terminal_prefix_passes
    (choice : EvenK8Choice)
    (hpass : Erdos848.globalMixedEvenTerminalCountsPasses
      8 choice.terminal = true) :
    Erdos848.globalMixedEvenTerminalPrefixPasses
      8 choice.terminal.endpoint choice.terminal.maskedPrefix = true := by
  apply Erdos848.globalMixedEvenTerminalPrefixPasses_of_counts
    (evenK8Choice_actual_counts choice)
