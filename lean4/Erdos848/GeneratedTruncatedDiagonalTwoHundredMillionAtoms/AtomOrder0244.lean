import Erdos848.GeneratedTruncatedDiagonalTwoHundredMillionAtoms.OrderBlock0388
...
theorem evenOneMarker4_30Ordered : evenOneMarker4_30.AdjacentOrdered := by
  apply IndexedMarkerData.adjacentOrdered_of_range (comparisonCount := 2860) (by decide)
