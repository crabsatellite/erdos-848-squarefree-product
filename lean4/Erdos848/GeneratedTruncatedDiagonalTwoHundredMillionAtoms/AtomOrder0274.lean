import Erdos848.GeneratedTruncatedDiagonalTwoHundredMillionAtoms.OrderBlock0418
...
theorem evenOneMarker5_11Ordered : evenOneMarker5_11.AdjacentOrdered := by
  apply IndexedMarkerData.adjacentOrdered_of_range (comparisonCount := 2852) (by decide)
