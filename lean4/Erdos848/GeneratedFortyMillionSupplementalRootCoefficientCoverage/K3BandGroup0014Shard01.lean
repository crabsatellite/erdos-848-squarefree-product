...
def k3BandGroup0014Shard01Rows : List (List Nat) :=
  (k3BandGroup0014Rows.drop 32).take 9

theorem k3BandGroup0014Shard01_passes :
    k3BandGroup0014Shard01Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0014Shard01_passes
