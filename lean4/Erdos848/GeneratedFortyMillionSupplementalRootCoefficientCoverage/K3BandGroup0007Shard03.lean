...
def k3BandGroup0007Shard03Rows : List (List Nat) :=
  (k3BandGroup0007Rows.drop 96).take 32

theorem k3BandGroup0007Shard03_passes :
    k3BandGroup0007Shard03Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0007Shard03_passes
