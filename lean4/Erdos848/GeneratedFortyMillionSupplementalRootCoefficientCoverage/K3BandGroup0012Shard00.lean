...
def k3BandGroup0012Shard00Rows : List (List Nat) :=
  (k3BandGroup0012Rows.drop 0).take 32

theorem k3BandGroup0012Shard00_passes :
    k3BandGroup0012Shard00Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0012Shard00_passes
