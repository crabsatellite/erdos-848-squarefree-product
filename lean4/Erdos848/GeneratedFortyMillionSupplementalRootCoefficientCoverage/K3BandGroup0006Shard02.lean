...
def k3BandGroup0006Shard02Rows : List (List Nat) :=
  (k3BandGroup0006Rows.drop 64).take 32

theorem k3BandGroup0006Shard02_passes :
    k3BandGroup0006Shard02Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0006Shard02_passes
