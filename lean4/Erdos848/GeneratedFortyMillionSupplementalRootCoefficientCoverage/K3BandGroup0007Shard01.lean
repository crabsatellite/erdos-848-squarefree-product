...
def k3BandGroup0007Shard01Rows : List (List Nat) :=
  (k3BandGroup0007Rows.drop 32).take 32

theorem k3BandGroup0007Shard01_passes :
    k3BandGroup0007Shard01Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0007Shard01_passes
