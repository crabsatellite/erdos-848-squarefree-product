...
def k3BandGroup0007Shard02Rows : List (List Nat) :=
  (k3BandGroup0007Rows.drop 64).take 32

theorem k3BandGroup0007Shard02_passes :
    k3BandGroup0007Shard02Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0007Shard02_passes
