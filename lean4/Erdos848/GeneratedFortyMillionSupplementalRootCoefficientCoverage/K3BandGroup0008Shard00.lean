...
def k3BandGroup0008Shard00Rows : List (List Nat) :=
  (k3BandGroup0008Rows.drop 0).take 32

theorem k3BandGroup0008Shard00_passes :
    k3BandGroup0008Shard00Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0008Shard00_passes
