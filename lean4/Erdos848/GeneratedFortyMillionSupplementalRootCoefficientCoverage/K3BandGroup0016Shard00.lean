...
def k3BandGroup0016Shard00Rows : List (List Nat) :=
  (k3BandGroup0016Rows.drop 0).take 32

theorem k3BandGroup0016Shard00_passes :
    k3BandGroup0016Shard00Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0016Shard00_passes
