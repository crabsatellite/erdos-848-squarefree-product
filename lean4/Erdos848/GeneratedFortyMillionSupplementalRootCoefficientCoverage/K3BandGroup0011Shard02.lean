...
def k3BandGroup0011Shard02Rows : List (List Nat) :=
  (k3BandGroup0011Rows.drop 64).take 13

theorem k3BandGroup0011Shard02_passes :
    k3BandGroup0011Shard02Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0011Shard02_passes
