...
def k3BandGroup0014Shard00Rows : List (List Nat) :=
  (k3BandGroup0014Rows.drop 0).take 32

theorem k3BandGroup0014Shard00_passes :
    k3BandGroup0014Shard00Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0014Shard00_passes
