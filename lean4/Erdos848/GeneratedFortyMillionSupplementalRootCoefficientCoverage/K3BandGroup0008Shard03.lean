...
def k3BandGroup0008Shard03Rows : List (List Nat) :=
  (k3BandGroup0008Rows.drop 96).take 32

theorem k3BandGroup0008Shard03_passes :
    k3BandGroup0008Shard03Rows.all fortyMillionK3BandPairPasses = true := by
  rfl

#print axioms k3BandGroup0008Shard03_passes
