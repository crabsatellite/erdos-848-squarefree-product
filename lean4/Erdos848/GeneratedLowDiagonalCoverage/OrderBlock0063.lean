...
def orderAll0063Tree : IndexedMarkerData.AdjacentIndexTree :=
...
theorem orderAll0063Check :
    orderAll0063Tree.check indexedMarker 125696 = true := by decide

theorem orderAll0063 :
    IndexedMarkerData.AdjacentIndexTree.RangeOrdered indexedMarker 125696 125761 := by
  simpa [orderAll0063Tree, IndexedMarkerData.AdjacentIndexTree.size] using
    IndexedMarkerData.AdjacentIndexTree.range orderAll0063Check
