...
def orderModOne0017Tree : IndexedMarkerData.AdjacentIndexTree :=
...
theorem orderModOne0017Check :
    orderModOne0017Tree.check modOneMarker 31360 = true := by decide

theorem orderModOne0017 :
    IndexedMarkerData.AdjacentIndexTree.RangeOrdered modOneMarker 31360 31425 := by
  simpa [orderModOne0017Tree, IndexedMarkerData.AdjacentIndexTree.size] using
    IndexedMarkerData.AdjacentIndexTree.range orderModOne0017Check
