...
def orderModOne0016Tree : IndexedMarkerData.AdjacentIndexTree :=
...
theorem orderModOne0016Check :
    orderModOne0016Tree.check modOneMarker 31232 = true := by decide

theorem orderModOne0016 :
    IndexedMarkerData.AdjacentIndexTree.RangeOrdered modOneMarker 31232 31361 := by
  simpa [orderModOne0016Tree, IndexedMarkerData.AdjacentIndexTree.size] using
    IndexedMarkerData.AdjacentIndexTree.range orderModOne0016Check
